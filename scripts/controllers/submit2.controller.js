...
(function (angular) {
    ...
    Submit2Function.$inject = ["$scope", "bonitaAuthentication", "ProcessDataOp", '$localStorage'];



    function Submit2Function($scope, bonitaAuthentication, ProcessDataOp, $localStorage) {
